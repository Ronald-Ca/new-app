...
export default function SkillCard({ skill, variants }: SkillCardProps) {
    return (
        ...
        >
            <Card
                className="
                    h-full bg-slate-900/50 border-cyan-500/50
            ...
            >
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <Badge
                            ...
                            className="
                                ...
                                font-semibold px-3 py-1 text-base
                            "
                        >
                            {skill.stars}/5
                        </Badge>
                ...
                <CardContent>
                    <div className="flex flex-col items-center gap-4">
                        <div className="
                            text-6xl text-cyan-400 p-4 rounded-full
                            bg-slate-800/60 border-2 border-cyan-500/30
                        ...
                        <div className="w-full flex flex-col gap-1">
                            <Progress
                                value={skill.stars * 20}
                                className="
                                    h-3 w-full bg-slate-800 rounded-full overflow-hidden
                                "
                            >
                                <div
